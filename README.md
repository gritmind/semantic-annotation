...
* With syntactic features elaborately designed by parsers, logistic regression as linear model also got high performances even with complex sequential problem. (Power of feature engineering!)
